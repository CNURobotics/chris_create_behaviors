...
@author: David Conner
'''
class CreatePurePursuitTestSM(Behavior):
    '''
    Test of the pure pursuit system with iRobot Create setup
    '''


    def __init__(self):
        super(CreatePurePursuitTestSM, self).__init__()
        self.name = 'Create Pure Pursuit Test'
    ...
    def create(self):
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('Stop',
                                        ...
                                        transitions={'done': 'finished', 'failed': 'EmergencyStop'},
